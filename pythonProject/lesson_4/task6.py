...
def create_phone_number(num_tuple): #ЛУЧШИЙ КОД
    str_phone = f"""(%s%s%s) %s%s%s-%s%s%s%s""" % (num_tuple[0], num_tuple[1], num_tuple[2], num_tuple[3], num_tuple[4], num_tuple[5], num_tuple[6], num_tuple[7], num_tuple[8], num_tuple[9])
    return str_phone
