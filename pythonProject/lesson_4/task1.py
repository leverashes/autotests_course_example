...
type_triangle = []
def which_triangle(a, b, c): # в итоге выдал 2 одинаковые версии пока игрался. Обе работают, обе об одном и том же
    # if a == b == c:
...
data = [
    ...
    (3, 4, 5),
    (3, 2, 3),
    (3, 2, 1), # Нахулиганил и добавил эту строчку себе для тестов. Простите, я не случайно
#    (1, 2, 3)
]
